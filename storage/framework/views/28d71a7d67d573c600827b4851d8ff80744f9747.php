...
<?php $component->withAttributes([]); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                  <button class="button is-small is-success js-modal-trigger" data-target="modal-view-data<?php echo e($author->id); ?>">
                                    <span class="icon-text">
                                        <span class="icon">
                                  ...
                                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.view-modal','data' => ['id' => 'modal-view-data'.e($author->id).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-view-data'.e($author->id).'']); ?>
...
<?php endif; ?>
                                ...
                                <td>
                                  ...
                                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.edit-modal','data' => ['id' => 'modal-edit-author'.e($author->id).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-edit-author'.e($author->id).'']); ?>
                                    <header class="modal-card-head">
                                      <p class="modal-card-title">Add a new Author</p>
                                      <button class="delete" aria-label="close"></button>
                                    </header>
...
<?php endif; ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-modal','data' => ['id' => 'modal-delete-book'.e($author->id).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-delete-book'.e($author->id).'']); ?>
                                      <header class="modal-card-head">
