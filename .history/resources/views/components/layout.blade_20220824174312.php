...
<head>
    ...
    <link rel="stylesheet" href="<?=base_urassets/css/all.min.css" type="text/css">
    <link rel="stylesheet" href="<?=base_urassets/css/bulma-rtl.min.css" type="text/css">
    <link rel="stylesheet" href="<?=base_urassets/css/bulma.min.css" type="text/css">
    <link rel="stylesheet" href="<?=base_urassets/css/dataTables.bulma.min.css" type="text/css">
    <link rel="stylesheet" href="<?=base_urassets/css/dataTables.dataTables.min.css" type="text/css">
    <link rel="stylesheet" href="<?=base_urassets/css/datatables.min.css" type="text/css">
    <link rel="stylesheet" href="<?=base_urassets/css/jquery.dataTables.min.css" type="text/css">
    <link rel="stylesheet" href="<?=base_urassets/css/modal-fx.min.css" type="text/css">
    <link rel="stylesheet" href="<?=base_urassets/css/animate.min.css" type="text/css">
