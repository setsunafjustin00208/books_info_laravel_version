...
<head>
    ...
    <link rel="stylesheet" href="<?=bassets/css/all.min.css" type="text/css">
    <link rel="stylesheet" href="<?=bassets/css/bulma-rtl.min.css" type="text/css">
    <link rel="stylesheet" href="<?=bassets/css/bulma.min.css" type="text/css">
    <link rel="stylesheet" href="<?=bassets/css/dataTables.bulma.min.css" type="text/css">
    <link rel="stylesheet" href="<?=bassets/css/dataTables.dataTables.min.css" type="text/css">
    <link rel="stylesheet" href="<?=bassets/css/datatables.min.css" type="text/css">
    <link rel="stylesheet" href="<?=bassets/css/jquery.dataTables.min.css" type="text/css">
    <link rel="stylesheet" href="<?=bassets/css/modal-fx.min.css" type="text/css">
    <link rel="stylesheet" href="<?=bassets/css/animate.min.css" type="text/css">
