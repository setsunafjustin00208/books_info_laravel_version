                            ...
                            @foreach($books as $book)
                                ...
                                <td>
                                  <div class="buttons">
                                    ...
                                    <div class="modal" id="modal-edit-book{{$book->id}}">
                                      <div class="modal-background"></div>
                                        <div class="modal-card">
                                          <header class="modal-card-head">
                                            ...
                                            <section class="modal-card-body">
                                              <form method="POST" action="/updatebook/{{$book->id}}">
                                                <div class="container">
                                                  <div class="field">
                                                    <label class="label">Title</label>
                                                    <div class="control">
                                                      <input class="input" type="text" value="{{$book->book_name}}" name="name" min=5 max=150 required>
                                                    </div>
                                                  </div>
                                                  <div class="field">
                                                    <label class="label">Author</label>
                                                  ...
                                                  <div class="field">
                                                    <label class="label">Publication Date and Time</label>
                                                    <div class="control">
                                                      <input class="input" type="datetime-local" value="<?=$bookrow->publication_date_n_time?>{{$book->description}}" name="publication_date_n_time" min=5 max=150 required>
                                                    </div>
                                                  </div>
                                    ...
                                    <div class="modal" id="modal-delete-book{{$book->id}}">
                                      <div class="modal-background"></div>
                                      <div class="modal-card">
                                          <header class="modal-card-head">
                                              ...
                                              <section class="modal-card-body">
                                                ...
                                                <input type="hidden" name="book_id" value="">
                                                  <p class="subtitle is-5"> 
                                                      Are you sure to delete this Book? {{$book->id}}
                                                  </p>
                                              </section>
                                          <footer class="modal-card-foot">
