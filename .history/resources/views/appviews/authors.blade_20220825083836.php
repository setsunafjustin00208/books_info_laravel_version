                    ...
                    <x-tables>
                        ...
                        <tbody>
                            @foreach($authors as $author)
                                ...
                                <td>{{$author->publication_date_n_time}}</td>
                                <td>{{$author->created_at}}</td>
                                <td>{{$author->updated_at}}</td>
                                <td>
                                  <div class="buttons">
                                    <button class="button is-warning js-modal-trigger" data-target="modal-edit-book{{$author->id}}">
                                      <span class="icon-text">
                                          <span class="icon">
                                    ...
                                    <div class="modal" id="modal-edit-book{{$author->id}}">
