                            ...
                            @foreach($authors as $author)
                                ...
                                <td>
                                  <div class="buttons">
                                    ...
                                    <div class="modal" id="modal-edit-author{{$author->id}}">
                                                  ...
                                                  <form method="POST" action="/updateauthor">
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="field">
                                                          <label class="label">Last name</label>
                                                          <div class="control">
                                                            <input class="input" type="text" value="{{$author->fname}}" name="lname" min=5 max=50>
                                                          </div>
                                                          @error('lname')
                                                          <label class="has-text-danger mb-2 mt-2">{{$message}}</label>
                                                        @enderror
                                                        ...
                                                        <div class="field">
                                                          <label class="label">Middle name</label>
                                                          <div class="control">
                                                            <input class="input" type="text" value="{{$author->fname}}" name="mname" min=5 max=50>
                                                          </div>
                                                          @error('mname')
                                                          <label class="has-text-danger mb-2 mt-2">{{$message}}</label>
                                                        @enderror
